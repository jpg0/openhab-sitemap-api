...
public class WidgetFactory {
    ...
    public Text newText(String item, String label, String icon, List<ColorArray> labelColor, List<ColorArray> valueColor, List<VisibilityRule> visibility, List<Widget> children) {
    ...
    private void fillLinkableWidget(LinkableWidget widget, String item, String label, String icon, List<ColorArray> labelColor, List<ColorArray> valueColor,
    ...
    private void fillWidget(Widget widget, String item, String label, String icon, List<ColorArray> labelColor, List<ColorArray> valueColor,
